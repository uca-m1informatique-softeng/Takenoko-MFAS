...
public class DeckTest {
    ...
    public void initialiserObjectifsJardinier() throws Exception {
        ObjectifJardinier [] deckjar = new ObjectifJardinier[3];
        deckjar[0] = new ObjectifJardinier(6,TypeParcelle.Jaune,4);
        deckjar[1] = new ObjectifJardinier(7,TypeParcelle.Rose,4);
        deckjar[2] = new ObjectifJardinier(5,TypeParcelle.Vert,4);
    ...
    public void initialiserObjectifsPanda() throws Exception {
        ObjectifPanda [] deckpan = new ObjectifPanda[3];
        deckpan[0] = new ObjectifPanda(4,TypeParcelle.Jaune,2);
        deckpan[1] = new ObjectifPanda(5,TypeParcelle.Rose,2);
        deckpan[2] = new ObjectifPanda(3,TypeParcelle.Vert,2);
